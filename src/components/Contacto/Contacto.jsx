...
import {TitulosSecciones} from "../TitulosSecciones/TitulosSecciones.js"
export const Contacto=()=>{
    return(
        <>
        <TitulosSecciones tittle={"Contacto"}></TitulosSecciones>
        <div className="contacto-container">
            <div className="row-contacto row">
                <div className="d-none d-xl-flex col-lg-6 container-pic">
                    <img className="imagen" src="https://i.postimg.cc/N0gH0gns/contacto.jpg"></img>
                    ...
                    <div className="container-form">
                        ...
                        <form className="formulario">
                            <div class="input-group mb-3">
                                <span
                                class="input-group-text d-sm-flex d-none" id="basic-addon1">Nombre y Apellido</span>
                                <input
                            ...
                            <div class="input-group mb-3">
                                <span
                                class="input-group-text d-sm-flex d-none" id="basic-addon1">Correo electrónico</span>
                                <input
                            ...
                            <div class="input-group mb-3">
                                <span
                                class="input-group-text d-sm-flex d-none" id="basic-addon1">Teléfono de contacto</span>
                                <input
                            ...
                            <div class="input-group">
                                ...
                                <textarea 
                                class="form-control input-form" placeholder="Consulta"
