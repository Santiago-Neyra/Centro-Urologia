                    ...
                    <div key={i}>
                        ...
                        <div className="col-3">
                            <div class="list-group">
                                ...
                                <a href="#realiza" className="list-group-item list-group-item-action">¿Por qué se realiza?</a>
                                <a href="#consiste" className="list-group-item list-group-item-action">¿En qué consiste?</a>
                                <a href='#preparacion' className="list-group-item list-group-item-action">Preparación</a>
                                <a href="#video" className="list-group-item list-group-item-action">Video</a>
                            </div>
