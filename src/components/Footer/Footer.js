    ...
    return(
        <div className="contenedor-footer">
            <div className="row row-1-footer">
                <div className="col-lg-3 justify-content-center align-items-center"><img className="icon-footer" src="https://i.postimg.cc/GhRrq0sD/a0831456-7d61-4379-b9b5-d6bb43160054-1.png"></img></div>
                ...
                <div className="col-lg-3 d-flex justify-content-center align-items-center">
                    <a href="#">
                    <BsInstagram className="icons" style={{color:"black"}} > </BsInstagram></a>
                    <a href="https://www.facebook.com/Centro-de-Urología-CDU-478609279004909" target={"_blank"}>
